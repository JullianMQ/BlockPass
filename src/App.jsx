      ...
      <Route
        ...
        element={
          <div className="bg-background text-on-surface selection:bg-primary selection:text-on-primary">
            <nav className="fixed top-0 z-50 flex w-full items-center justify-between border-b border-outline-variant/10 px-8 py-4 glass">
              ...
              <div className="flex items-center gap-4">
                ...
                {isAuthenticated ? (
                  <>
                    <button className="rounded-full p-2 transition-colors hover:bg-surface-container-highest">
                      <span className="material-symbols-outlined text-on-surface-variant">
                    ...
                    <div className="flex items-center gap-3 rounded-full border border-outline-variant/20 bg-surface-container-high px-4 py-1.5">
                      ...
                      <img
                        alt="Abstract geometric user avatar representing a blockchain wallet"
                        className="h-6 w-6 rounded-full"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuBDr-AscXIt3QzWoeMKmjqZRN01BwtPQlMIEQ8S4XFmQB15I03zEgGO9X9cs4o95vzhDoBfk0X4WdRQ3fIAAx0fHGe3_d2Wv3NYSGQeNyswm-5vshgY0XGsGNg27Y_FhrKkUdyMN9zY_HukwhptL4feWaNxHwx5KuG546sr1G_9hCN5nkWvtb4yK1dehuH_mA1FfP9nwDj0-NESuVOC1tw6E1Vjg-lDbrjJmHmwIM0mN4vxzGPCs4XePuvVIgvbnaIfZfdPf7oJ7hGL"
                      />
                    </div>
                  </>
                ) : (
                  <Link
                    className="ghost-border rounded-full px-5 py-2 text-xs font-bold text-on-surface transition-colors hover:bg-surface-container-low"
                    to="/login"
                  >
                    Sign In
                  </Link>
        ...
        <section className="relative flex min-h-[90vh] flex-col justify-center overflow-hidden px-8 lg:px-24">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="mb-8 font-headline text-6xl font-bold leading-[1.05] tracking-tighter md:text-8xl">
              ...
              It's an <span className="italic">Artifact.</span>
            </h1>
            <p className="mb-12 max-w-2xl font-body text-xl leading-relaxed text-on-surface-variant">
              BlockPass Pro redefines event access through the Ethereal Ledger—a
              high-fidelity blockchain architecture where security meets luxury
              editorial design.
            </p>
            <div className="flex flex-wrap gap-6">
              <button className="signature-gradient rounded-full px-10 py-4 font-label text-lg font-bold text-on-primary transition-all hover:shadow-[0_0_30px_rgba(192,193,255,0.4)]">
                Get Started
              </button>
              <button className="ghost-border rounded-full px-10 py-4 font-label text-lg font-bold transition-colors hover:bg-surface-container-low">
                View Marketplace
              </button>
            </div>
          </div>
          ...
          <div className="mb-20 flex flex-col items-end justify-between gap-8 md:flex-row">
            <div className="max-w-2xl">
              ...
              <p className="font-body text-lg text-on-surface-variant">
                Our protocol eliminates the friction of secondary markets while
                preserving the emotional value of the event experience.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="group flex flex-col gap-8 rounded-xl bg-surface-container-low p-12 transition-colors hover:bg-surface-container">
              ...
              <div className="space-y-4">
                ...
                <p className="font-body leading-relaxed text-on-surface-variant">
                  Programmable royalties and price ceilings embedded directly
                  into the ticket ledger. Fair access for true fans, every
                  single time.
                </p>
              </div>
            </div>
            ...
            <div className="group flex flex-col gap-8 rounded-xl bg-surface-container-low p-12 transition-colors hover:bg-surface-container">
              ...
              <div className="space-y-4">
                ...
                <p className="font-body leading-relaxed text-on-surface-variant">
                  Tickets evolve into digital memorabilia after the event.
                  Unlock exclusive content, airdrops, and future access based on
            ...
            <div className="group flex flex-col gap-8 rounded-xl bg-surface-container-low p-12 transition-colors hover:bg-surface-container">
              ...
              <div className="space-y-4">
                ...
                <p className="font-body leading-relaxed text-on-surface-variant">
                  Verify your identity and ticket validity without ever exposing
                  your personal data. Professional-grade privacy for the modern
                  era.
                </p>
              </div>
            </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-body text-on-surface-variant">
                      Trace every hand a ticket has passed through. A crystal-
                      clear history from the organizer to the front row.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-body text-on-surface-variant">
                      Tickets that change state. VIP access unlocks in real-
                      time as you approach the venue gates.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-body text-on-surface-variant">
                      Trade, fractionalize, or collateralize high-value season
                      passes across any EVM-compatible chain.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="relative px-8 py-40 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mb-12 font-body text-xl text-on-surface-variant">
              Join 10,000+ organizers already using BlockPass to secure their
              event ecosystem.
            </p>
        ...
        <div className="mb-20 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-1">
            <div className="mb-6 flex items-center gap-3">
              ...
              <span className="font-headline text-xl font-bold">BlockPass</span>
            </div>
            <p className="mb-8 text-sm leading-relaxed text-on-surface-variant">
              The premium protocol for blockchain-native ticketing and event
              heritage management. Built for the Ethereal Ledger.
            </p>
            <div className="flex gap-4">
              <a
